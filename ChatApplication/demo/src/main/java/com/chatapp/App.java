...
public class App extends Application {
    ...
    /**
     * Default host name. This is the initial content of the input box
     * that
    ...
    /**
     * Input boxes for connection information (port numbers and host
     * names).
     */
    private TextField listeningPortInput, remotePortInput,
            remoteHostInput;
    /**
...
ConnectionHandler(remoteHostInput.getText(),port);
...
/**
* Save the contents of the transcript area to a file selected by the
user.
*/
private void doSave() {
FileChooser fileDialog = new FileChooser();
fileDialog.setInitialFileName("transcript.txt");
fileDialog.setInitialDirectory(new
...
errorMessage("Sorry, but an error occurred while\ntrying to write the text:\n" + e);
    ...
    /**
     * Defines the thread that handles the connection. The thread is
     * responsible
     * for opening the connection and for receiving messages. This class
     * contains
     * several methods that are called by the main class, and that are
     * therefore
     * executed in a different thread. Note that by using a thread to
     * open the
     * connection, any blocking of the graphical user interface is
     * avoided. By
     * using a thread for reading messages sent from the other side, the
     * messages
     * can be received and posted to the transcript asynchronously at the
     * same
     * time as the user is typing and sending messages. All changes to
     * the GUI
    ...
    private class ConnectionHandler extends Thread {
        ...
        /**
         * Open a connection to specified computer and port. The
         * 
         * constructor
         * 
         * does not perform any network operations; it just sets some
...
/**
* Send a message to the other side of the connection, and post

the

* message to the transcript. This should only be called when the
* connection state is ConnectionState.CONNECTED; if it is called
...
close();
        ...
        /**
         * 
         * This is called by the run() method when a message is received
         * 
         * from
         * 
         ...
         * (This
         * 
         * is because a message might be received after the user has
         * 
         * clicked
         * 
         ...
         * message to the transcript, and sets the connected state to
         * 
         * CONNECTED.
         */
        ...
        /**
         * This is called by the run() method when the connection is
         * 
         * closed
         * 
         * from the other side. (This is detected when an end-of-stream
         * 
         * is
         * 
